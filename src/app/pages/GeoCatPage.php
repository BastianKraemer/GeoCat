...
?>
		...
		<div class="popup-login" data-role="popup" data-arrow="true" data-theme="a" class="ui-corner-all">
          ...
          <button onclick="GeoCat.logout(null, '<?php echo $pathToRoot ?>'); $('#popup-login-' + $.mobile.activePage.attr('id')).popup('close')" class="ui-btn ui-shadow ui-btn-inline ui-mini ui-corner-all"><?php $locale->write("logout"); ?></button>
        </div>
		</div>
