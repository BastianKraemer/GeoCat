...
?>
	<div data-role="page" id="ChallengeNavigator" data-theme="a">
		...
		<div class="substance-footer">
			<a href="#challenge-navigator-stats-panel" data-rel="panel" class="substance-button substance-button-grow substance-animated substance-purple" style="background-image: url('./img/stats.png');"></a>
			<span id="challenge-navigator-update-button" class="substance-button substance-button-grow substance-animated substance-lime" style="background-image: url('./img/update.png');"></span>
			<span id="checkpoint-reached-button" class="substance-button substance-button-grow substance-animated substance-blue" style="background-image: url('./img/flag.png');"></span>
			<a href="#challenge-navigator-coord-panel" data-rel="panel" class="substance-button substance-button-grow substance-animated substance-orange" style="background-image: url('./img/list.png');"></a>
		</div>
