			...
			<div class="substance-center-flexcontainer" style="min-height: 100%">
				<div class="substance-half-window substance-box">
					...
					<div id="EditCoordinate-code-container" style="display: none">
					 ...
					 <div class="center">
						<span id="EditCoordinate-cancel" class="substance-button substance-button-animated substance-red" style="background-image: url('./img/delete.png'"></span>
						<span id="EditCoordinate-confirm" class="substance-button substance-button-animated substance-green"  style="background-image: url('./img/check.png'"></span>
					</div>
				</div>
			</div>
		</div>
